        ...
        <div class="col-md-5 border-right">
            ...
            <?php include('errors.php'); ?>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6"><label class="labels">Name: </label><input type="text"  class="form-control"  value="<?php echo $username; ?>" name="username"></div>                           
                    <div class="col-md-6"><label class="labels">Company Name: </label><input type="text"  class="form-control"  value="<?php echo $CompanyName; ?>" name="CompanyName"></div>    
                  </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Company Address: </label><textarea  class="form-control" name="Location"><?php echo $Location; ?></textarea></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Email: </label><input type="text"  class="form-control"  value="<?php echo $email; ?>" name="email"></div>                           
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Emergency Email: </label><input type="text"  class="form-control"  value="<?php echo $emergencyemail; ?>" name="emergencyemail"></div>                           
                </div>
                <div class="row mt-3">
                    <div class="col-md-6"><label class="labels">Contact Number: </label><input  type="number" class="form-control" name="ContactNumber" value="<?php echo $ContactNumber; ?>"></div>
                    <div class="col-md-12"><label class="labels">SOS Department Contact Number: </label><input  type="text" class="form-control" value="<?php echo $DepartmentNumber; ?>" name="DepartmentNumber"></div>
                </div>
                <div class="row mt-3">
                <div class="col-md-12"><label for="floatingTextarea">SOS Message: </label><textarea class="form-control"   name="Message"><?php echo $Message; ?></textarea></div>                    
                </div>
                <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit" name="editsosdetails">Save Profile</button></div>
            </form>
