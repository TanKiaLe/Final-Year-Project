        ...
        <table class="table table-hover">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editalarm1.php?edit1=<?php echo $row['aid']; ?>"
                               class = "btn btn-info" onclick="show()" >Edit</a>
                            <a href="server.php?delete1=<?php echo $row['aid']; ?>"
        ...
        <table class="table table-hover">
                ...
                ?> 
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editzone1.php?edit=<?php echo $id; ?>"
                               class="btn btn-success editbtn">Edit</a>
                            <a href="server.php?delete=<?php echo $id; ?>"
                               class = "btn btn-danger" >Delete</a>
                        </td>
                    </tr>
