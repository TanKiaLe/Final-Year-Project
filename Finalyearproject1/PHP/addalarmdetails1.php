...
<div class="regform"><h1>Alarm Details</h1></div>
<div class="main">
<?php include('errors.php'); ?>
<form action="addalarmdetails1.php" method="POST">
  
  <input type="hidden" name="userid" value="<?php echo $_SESSION['user_id'] ?>" ><br /><br />
  <div class="mb-3">
    <label for="exampleInputBuildingName" class="form-label" name="labelbuildingname">Building Name: </label>
    <input type="text" class="form-control" name="buildingname" placeholder="Main Hall">
  </div>
  <div class="mb-3">
    <label for="exampleInputFloor" class="form-label">Floor</label>
    <input type="text" class="form-control" placeholder="How Much Floor This Building Have" name="floor">
  </div>
  <button type="submit" class="btn btn-primary" name="addalarmdetails" >Submit </button>
</form>
</div>
