...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/evo-calendar.min.css"></link> 
    <link rel="stylesheet" type="text/css" href="../CSS/evo-calendar.midnight-blue.min.css"></link>
...
<div class="hero" style="width:100%; height:100%; background: linear-gradient(45deg,#6ac1c5,#bda5ff); position: relative;">

<div id="calendar" style="width:80%; top:50%;"></div>

</div>

 <script src="https://cdn.jsdelivr.net/npm/jquery@3.4.1/dist/jquery.min.js"></script>
    <script src="../PHP/evo-calendar.min.js"></script>
    <script>
      ...
      $(document).ready(function() {
        ...
        ?>
        {
        id: '<?php echo $calendarID; ?>', // Event's ID (required)
        name: '<?php echo $title; ?>', // Event name (required)
        date: '<?php echo $date; ?>', // Event date (required)
        type: '<?php echo $type; ?>', // Event type (required)
        description: '<?php echo $description; ?>' // Same event every year (optional)
        },<?php }}?>
    ]
