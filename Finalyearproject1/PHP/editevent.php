...
?> 
<div class="regform"><h1>Edit Event Details</h1></div>
<div class="main">
<?php include('errors.php'); ?>
<form action="editevent.php" method="POST">
  <input type="hidden" value="<?php echo $calendarID ; ?>" name="calendarID" >
  <div class="mb-3">
    <label  class="form-label" name="labelbuildingname">Title : </label>
  ...
  <input type="button" onclick="location.href='listevent.php'" value="Cancel" class="btn btn-primary"/>
</form>
</div>
</body>
</html>