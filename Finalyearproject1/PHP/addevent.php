...
<div class="regform"><h1>Add Event</h1></div>
<div class="main">
<?php include('errors.php'); ?>
<form action="addevent.php" method="POST">
                <div class="mb-3">
                    <input type="hidden" value="<?php echo $_SESSION['user_id'] ?>" name="user_id" >
                    <div><label class="form-label">Title</label><input type="text" class="form-control" placeholder="" name="title"></div>                           
                </div>
                <div class="mb-3">
                    <div><label class="form-label">Date</label><textarea class="form-control"  name="date">Example(December/1/2021)</textarea></div>
                </div>
                <div class="mb-3">
                    <div><label class="form-label">Type</label><input type="text" class="form-control" placeholder="Event / Activity" name="type"></div>
                </div>
                <div class="mb-3">
                <div><label class="form-label">Description</label><textarea class="form-control" placeholder="Leave description here"  name="description"></textarea></div>                    
                </div>
                <div><button class="btn btn-primary profile-button" type="submit" name="addevent">Add</button></div>
</form>
</div>
</nav>
